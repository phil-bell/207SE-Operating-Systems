...
int main()
{
  ...
  */
  ...
  cout << "\n Enter 3 characters, 2 numbers followed by what you would like to operate on them (+,-,*,/):\n";//I changes the output that tells the user what to do to be more relivant to the task
